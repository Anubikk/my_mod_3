...
//   route parameter, `:dogId`
   ...
   if(req.method === "GET" && req.url.startsWith("/dogs/:dogId")) {
      res.statusCode = 200;
      res.setHeader("Content-Type", "text/plain");
      const dogId = req.url.split("/")[2]; //declare dogId to be the second element of the array created by splitting the url at "/"
      return res.end(`Dog details for dogId: ${dogId}`); //return the dogId
    }
